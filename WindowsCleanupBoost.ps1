...
$Label1.text                     = "Run Clean-Up + Boost:"
...
$RemoveAppx.TextAlign             = [System.Drawing.ContentAlignment]::Middle

$RestoreAppx                     = New-Object system.Windows.Forms.Button
$RestoreAppx.text                = "Restore Appx"
$RestoreAppx.width               = 235
...
$RestoreAppx.TextAlign           = [System.Drawing.ContentAlignment]::Middle
...
$ScanWindows.TextAlign           = [System.Drawing.ContentAlignment]::Middle
...
$RemoveOneDrive.TextAlign        = [System.Drawing.ContentAlignment]::Middle
...
$CleanBoost.width                = 235
$CleanBoost.height               = 84
$CleanBoost.location             = New-Object System.Drawing.Point(17,53)
$CleanBoost.Font                 = New-Object System.Drawing.Font('Arial',14,[System.Drawing.FontStyle]([System.Drawing.FontStyle]::Bold))
$CleanBoost.ForeColor            = [System.Drawing.ColorTranslator]::FromHtml("#093a60")
$CleanBoost.BackColor            = [System.Drawing.ColorTranslator]::FromHtml("#2b9eff")
...
$MoveUpdateFolder.TextAlign      = [System.Drawing.ContentAlignment]::Middle
...
$RestoreUpdate.TextAlign         = [System.Drawing.ContentAlignment]::Middle
...
$Label6.width                    = 543
$Label6.height                   = 30
$Label6.location                 = New-Object System.Drawing.Point(301,332)
$Label6.Font                     = New-Object System.Drawing.Font('Arial',14)
$Label6.BorderStyle              = [System.Windows.Forms.BorderStyle]::FixedSingle

$PictureBox1                     = New-Object system.Windows.Forms.PictureBox
$PictureBox1.width               = 61
$PictureBox1.height              = 61
$PictureBox1.location            = New-Object System.Drawing.Point(21,63)
$PictureBox1.imageLocation       = "https://github.com/MartijnGriekje/Windows-System-Clean-Boost/raw/main/logoSquare.png"
$PictureBox1.SizeMode            = [System.Windows.Forms.PictureBoxSizeMode]::zoom
$PictureBox1.BringToFront()     

$Form.controls.AddRange(@($PictureBox1,$CleanBoost,$Label1,$RemoveAppx,$RestoreAppx,$Label3,$Label2,$RemoveRestore,$RemoveOneDrive,$ScanWindows,$Label4,$MoveUpdateFolder,$RestoreUpdate,$ProgressBar1,$Reboot,$Label5,$ExitButton,$SpaceFreed,$Feed,$Label6))
...
Function Process-Updates()
{
	...
	{
		$updatepath = "$env:HOMEDRIVE\CleanUpAll\update.ps1"
...
if (test-path $env:HOMEDRIVE\ProgramData\Microsoft\Windows\WER) {Get-ChildItem -Path $env:HOMEDRIVE\ProgramData\Microsoft\Windows\WER -Recurse | Remove-Item -force -recurse}
}
...
if(Test-Path -Path "$env:HOMEDRIVE\ServiceProfiles\LocalService\AppData\Local\Temp\*"){Remove-Item -Path "$env:HOMEDRIVE\ServiceProfiles\LocalService\AppData\Local\Temp\*" -Force -Recurse}
...
Get-ChildItem "$env:HOMEDRIVE\inetpub\logs\LogFiles\*" -Recurse -Force | Where-Object { ($_.CreationTime -le $(Get-Date).AddDays(-60)) } | Remove-Item -Force -Recurse
...
Start-Process -FilePath "$env:HOMEDRIVE\Program Files\CCleaner\CCleaner64.exe" -ArgumentList "/AUTO" -Wait -WarningAction SilentlyContinue
}
}
